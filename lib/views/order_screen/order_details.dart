...
class OrderDetails extends StatefulWidget {
  final dynamic data;
  const OrderDetails({Key? key, this.data});
...
class _OrderDetailsState extends State<OrderDetails> {
  ...
  void initState() {
    ...
    controller.ondelivery.value = widget.data['order_on_delievery'];
                  ...
                  children: [
                    ...
                    SwitchListTile(
                      ...
                      onChanged: (value) {
                        ...
                        controller.changeStatus(title: "order_on_delievery", status: value, docID: widget.data.id);
                      },
                              ...
                              SizedBox(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    "${widget.data['total_amount']}".numCurrency.text.make(),
                                  ],
                                ),
                              ),
                            ],
                    ...
                    const Divider(),
                    10.heightBox,
                    "Order Product".text.size(15).makeCentered(),
                    10.heightBox,
                    ListView(
